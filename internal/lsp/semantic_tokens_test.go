...
`
	...
	assertSemanticToken(t, decoded, "ADMIN", protocol.SemanticTokenEnumMember, []protocol.SemanticTokenModifiers{protocol.SemanticTokenModifierDeclaration})
	...
	assertSemanticToken(t, decoded, "id", protocol.SemanticTokenProperty, []protocol.SemanticTokenModifiers{protocol.SemanticTokenModifierDeclaration})
